        ...
        <div class="container col-lg-9">
            ...
            <div class="d-md-flex justify-content-between">
                ...
                <div class="d-flex align-items-center py-2">
                    <div class="shadow p-1 rounded-8">
                        <img class="" src="{{ asset('images/logos/uni_logo.png') }}" alt="MyADC"
                            style="width: 80px">
                    </div>
                    <div class="ms-4">
                        <h1 class="text-primary mt-3 fw-bold mb-0">LU Bus</h1>
                        <p>A Bus transport management platform</p>
                    </div>
                </div>

                <div class="d-flex align-items-center justify-content-end mb-3">
                    @auth
                        <a class="btn btn-primary ms-2" href="{{ route('dashboard') }}"><i class="fas fa-home"></i>
                            Home</a>
                    @else
            ...
            <div class="row d-md-flex align-items-center">
                <div class="col-md-5 col-lg-6 p-3 p-lg-5">
                    <img class="img-fluid mb-3" src="{{ asset('images/asset_img/home_vector.jpg') }}" alt="">
                ...
                <div class="col-md-7 col-lg-6">
                    <div class="card px-md-4 py-3 rounded-8 shadow-lg">
                        <div class="card-header d-flex justify-content-between align-items-start">
                            <div>
                                <h2>Login</h2>
                                <p>Welcome to LU Bus</p>
                            </div>
                            <a class="btn btn-link btn-sm" href="{{ route('admin.login') }}" target="blank">Admin
    ...
    <footer class="py-3 mt-5">
        <div class="container">
            <div class="d-flex justify-content-center">
                ...
                <img class="ms-4" src="{{ asset('images/logos/Robi.png') }}" alt="" style="height: 45px;">
            </div>
    ...
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                @auth('admin')
                    <a href=" {{ route('admin.dashboard') }} " style="color: #fff">Admin Dashboard</a>
                @else
                    <a href=" {{ route('admin.login') }} " style="color: #fff">Admin Login</a>
                @endauth
            </div>
