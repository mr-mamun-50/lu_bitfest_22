                    ...
                    <div class="card-body">
                        <form action="{{ route('profile.update', Auth::user()->id) }}" method="POST">
                            ...
                            <div class="mb-3 d-flex">
                                ...
                                <input type="text" class="form-control w-75 ms-auto" id="address" name="t_dept"
                                    value="{{ Auth::user()->t_dept }}">
                            </div>
                            <div class="mb-3 d-flex">
                                <label for="address" class="form-label">Designation:</label>
                                <input type="text" class="form-control w-75 ms-auto" id="address"
                                    name="t_designation" value="{{ Auth::user()->t_designation }}">
                            </div>
